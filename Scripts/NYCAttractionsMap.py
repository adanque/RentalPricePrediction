...
Author: Alan Danque
Date:   20210323
Purpose:Creates map of the NYC Attractions
...
df = pd.read_csv('C:/Alan/DSC680/Project1Data/NYCAttractions.csv')
...
laMap.save('NYC_Attractions_Map.html')


#initialize the NYC County map
...
#save the map as an html
laMap.save('NYC_Attractions_Heatmap.html')
