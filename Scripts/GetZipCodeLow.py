...
Complete: --- 17161.04101538658 seconds has passed ---
"""
import geopy
import pandas as pd
import yaml
...
filepath_final_out = "C:/Alan/DSC680/Project1Data/MasterDataset_low.csv"
data = pd.read_csv(filepath)

pysqldf = lambda t: sqldf(t, globals())
# t = """SELECT distinct interest_level from t_df ;"""
t = "SELECT * from data where interest_level = 'low';"
print(t)
qrt_df = pysqldf(t)
