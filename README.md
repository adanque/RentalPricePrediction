...
After feeding in the values for latitude, longitude and amenity information, my prediction code imputes the rest of the distance variables and makes pricing predictions.
...
However, since my Renthop apartment inventory data is from 2017, my predicted prices are 4 years old. Given that the market usually raises prices by $90-$150 each year, I believe my prediction power is working correctly. The current rental price for the apartment in my example is 3482. Which is a difference of $530. Thus this would have been a yearly rent increase of $132 in lease rents.
